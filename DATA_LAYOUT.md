...
│   ├── revbayes/            # RevBayes scripts, data, trees, outputs [mostly local only]
...
|---------|---------------|
| Sequences & RevBayes | `G:\My Drive\OneDrive_Migration\Phylogeny\` |
| RevBayes analyses | `G:\My Drive\OneDrive_Migration\RevBayes\` |
| Manuscript (Google Docs) | `G:\My Drive\Multilocus Species-Tree Reconstruction... (Paragalago).gdoc` |
| Active analyses & exports | `C:\Users\galag\GitHub\jobb-ansökningar\research\galagos\` |
